/** @file SOURCE/parallelSourceNormal.cpp
...
parallelSourceNormalReal::parallelSourceNormalReal(std::shared_ptr<mpiInterface> gridComm, std::vector<std::shared_ptr<Pulse>> pulse, real_pgrid_ptr grid, double dt, std::array<int,3> loc, std::array<int,3> sz) :
...
parallelSourceNormalCplx::parallelSourceNormalCplx(std::shared_ptr<mpiInterface> gridComm, std::vector<std::shared_ptr<Pulse>> pulse, cplx_pgrid_ptr grid, double dt, std::array<int,3> loc, std::array<int,3> sz) :
