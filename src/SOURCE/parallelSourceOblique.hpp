...
public:
     ...
     */
    parallelSourceObliqueBase(std::shared_ptr<mpiInterface> gridComm, std::vector<std::shared_ptr<Pulse>> pulse, std::shared_ptr<parallelGrid<T>> grid, POLARIZATION pol, double dt, std::array<int,3> loc, std::array<int,3> sz, double phi, double theta) :
...
public:
     ...
     * @param[in]  sz         size of the soft source
     */
    parallelSourceObliqueReal(std::shared_ptr<mpiInterface> gridComm,  std::vector<std::shared_ptr<Pulse>> pulse, real_pgrid_ptr grid, POLARIZATION pol, double dt, std::array<int,3> loc, std::array<int,3> sz, double phi, double theta);
    /**
     * @brief      adds the pulse to the grid
     *
     * @param[in]  t     current time
...
public:
     ...
     * @param[in]  sz         size of the soft source
     */
    parallelSourceObliqueCplx(std::shared_ptr<mpiInterface> gridComm,  std::vector<std::shared_ptr<Pulse>> pulse, cplx_pgrid_ptr grid, POLARIZATION pol, double dt, std::array<int,3> loc, std::array<int,3> sz, double phi, double theta);
    /**
     * @brief      adds the pulse to the grid
     *
     * @param[in]  t     current time
