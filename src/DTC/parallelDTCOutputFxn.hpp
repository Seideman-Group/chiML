/** @file DTC/parallelDTCOutputFxn.hpp
 *  @brief Functions that convert field data into the correct form for the detectors
 *
...
{
    std::transform(gridInBegin, gridInEnd, valsOut, valsOut, [&](T pt, T curVal){return curVal + convFactor*pt;} );
};
